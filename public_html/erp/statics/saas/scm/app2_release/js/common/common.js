...
Business.customerCombo = function($_obj, opts){
	...
	var opts = $.extend(true, {
		...
		defaultSelected: 0,
		editable: true,
		extraListHtml: '<a href="javascript:void(0);" id="quickAddCustomer" class="quick-add-link"><i class="ui-icon-add"></i>新增门店</a>',
		maxListWidth: 500,
		cache: false,
...
Business.formatGoodsName = function(good){
	...
	return name + spec + qtyStr;//number + ' ' + 
}
...
Business.goodsCombo = function($_obj, opts){
	...
	var opts = $.extend(true, {
		...
		defaultSelected: -1,
		editable: true,
		extraListHtml: '<a href="javascript:void(0);" class="quick-add-link quickAddGoods"><i class="ui-icon-add"></i>快速新增商品</a>',
		maxListWidth: 500,
		cache: false,
		forceSelection: true,
		trigger: false,
