...
var THISPAGE = {
	...
	initDom: function(a) {
		...
		var b = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">保存并新增</a><a id="save" class="ui-btn">保存</a>',
			c = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/receipt/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">打印</a><a id="edit" class="ui-btn mrb">保存</a>',
			d = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/receipt/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">打印</a><b></b></a>',
			e = "",
			f = "",
			g = "";
	...
	loadGrid: function(a) {
		...
		h.mod_PageConfig.gridReg("accountGrid", l, "结算"), l = h.mod_PageConfig.conf.grids.accountGrid.colModel, $("#accountGrid").jqGrid({
			data: a.accounts,
			datatype: "clientSide",
			autowidth: !0,
			height: "100%",
	...
	extendFun: function(a) {
		...
		b.mod_PageConfig.gridReg("grid", f, "原单"), f = b.mod_PageConfig.conf.grids.grid.colModel, $("#grid").jqGrid({
			data: a.entries,
			datatype: "clientSide",
			autowidth: !0,
			height: "100%",
	...
	addEvent: function() {
		...
		this.customerCombo.input.enterKey(), this.$_note.enterKey(), this.$_date.bind("keydown", function(a) {
			...
			a.preventDefault(), Business.verifyRight("RECEIPT_ADD") && parent.tab.overrideSelectedTabItem({
				tabid: "money-receipt",
				text: "收款单",
				url: "../scm/receipt/initReceipt?action=initReceipt"
			})
