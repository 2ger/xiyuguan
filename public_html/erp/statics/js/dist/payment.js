...
var THISPAGE = {
	...
	initDom: function(a) {
		...
		var b = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">保存并新增</a><a id="save" class="ui-btn">保存</a>',
			c = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/payment/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">打印</a><a id="edit" class="ui-btn mrb">保存</a>',
			d = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/payment/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">打印</a><b></b></a>',
			e = "",
			f = "",
			g = "";
	...
	addEvent: function() {
		...
		this.customerCombo.input.enterKey(), this.$_note.enterKey(), this.$_date.bind("keydown", function(a) {
			...
			a.preventDefault(), Business.verifyRight("PAYMENT_ADD") && parent.tab.overrideSelectedTabItem({
				tabid: "money-payment",
				text: "付款单",
				url: "../scm/payment/initPay?action=initPay"
			})
