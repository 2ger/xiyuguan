...
<table width="100%" class="ui-jqgrid-btable">
        <tr><td class='H' align="center" colspan="10"><h3>店面销售量参考</h3></td></tr>
      </table>
    <table class="ui-jqgrid-btable" width="100%" border=1 cellspacing="0" cellpadding="0">
      <thead>
        <tr class="ui-state-default ui-th-column ui-th-ltr">
            <th class="ui-state-default ui-th-column ui-th-ltr">编号</th>
      ...
      <tbody>
        ...
        <tr class="ui-widget-content jqgrow ui-row-ltr selected-row">
          ...
          <td ><?php echo $row['count']['count']?></td>
        </tr>
        <?php }?>
 </tbody>
</table>
