...
<head>
<title>打印 <?php echo $transType==150601 ? '销货订单' :'销货退货订单'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		...
		<table width="800" align="center">
			<tr height="15" align="left">
				<td width="220" style="font-family:'宋体'; font-size:12px;height:20px;">门店：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="120" style="font-family:'宋体'; font-size:12px;height:20px;">制单人员：<?php echo $salesName?></td>
		...
		<table width="900" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			<tr style="height:20px">
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">规格</td>	
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center"><?php echo $type==1 ? '成本价' :'配送价'?></td>	
					...
					<td width="50" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">备注</td>	
				</tr>
		       <?php 
			   $i = ($t-1)*$num + 1;
			   ...
			   ?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
				   <td width="30"  align="center"><?php echo $row['i']?></td>
					...
					<td width="60" align="right"><?php echo $row['spec']?></td>
					...
					<td width="50" align="right"><?php echo $row['description']?></td>
				</tr>
				<?php 
				    $s = $row['i'];
				    }
				...
				?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
				   <td align="center" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;"><?php echo $m?></td>
					<td ></td>
					<td ></td>
					<td ></td>
					<td ></td>
