    	...
    	<form id="manage-form" action="">
    		...
    		<ul class="mod-form-rows base-form" id="base-form">
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="select">选择仓库</label></div>
                    <div class="ctn-wrap">
<select id="selectname" name="selectname" style="
    height: 30px;
    width: 210px;
    background: yellow;
">
...
<?php foreach($list as $item){?>
    <option value="<?php echo $item['locationNo']?>"><?php echo $item['name']?></option>
<?php } ?>
</select>
...
$("#selectname").change(function() {
    ...
    $('#name').val(name);
    			...
    			</li><li class="row-item odd">
    				<div class="label-wrap"><label for="number">门店编号</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number" disabled></div>
    			</li>
    			<li class="row-item">
                <div class="label-wrap"><label for="name">门店名称<?php //var_dump($list); ?></label></div>
                    <div class="ctn-wrap">

<input type="text" value="" class="ui-input" name="name" id="name" disabled></div>
    			</li>
    			<li class="row-item odd row-category">
    				<div class="label-wrap"><label for="category">门店类别</label></div>
    				<div class="ctn-wrap"><span id="category"></span></div>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="customerLevel">门店等级</label></div>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js?ver=201510141132"></script>
</body>
</html>
