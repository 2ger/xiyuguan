            ...
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    ...
                    <li class="row-item row-category">
                        <div class="label-wrap"><label for="unit">进货单位</label></div>
                        <div class="ctn-wrap"><span id="unit"></span></div>
                    </li>
                    
<!--                    <li class="row-item ">
                        <div class="label-wrap"><label for="guarantDate">销售单位</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="costUnitId" id="costUnitId"></div>
                    </li>
-->

                    <li class="row-item ">
                        <div class="label-wrap"><label for="warnDate">销售换算</label></div>
                        <div class="ctn-wrap"><input type="text" value="1" class="ui-input" name="costUnitId" id="costUnitId" style="width:70px">
<select id="costName" name="costName" style="
    height: 30px;
    width: 60px;
    background: yellow;
">
...
<?php } ?>
                ...
                <div class="liGroup cf">
                    ...
                    <ul class="mod-form-rows base-form cf">
                        <li class="row-item">
                            <div class="label-wrap"><label for="salePrice">配送价</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="salePrice" id="salePrice"></div>
                        </li>
                        <li class="row-item">
                            <div class="label-wrap"><label for="wholesalePrice">成本价</label></div>
