...
<div class="print-settings-wrap">
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        <p class="print-tips">如果无法正常打印，请先下载安装<a href="http://dl.pconline.com.cn/html_2/1/81/id=1322&pn=0&linkPage=1.html" target="_blank">Adobe PDF阅读器</a></p>
      ...
      <div class="item taoda-settings" id="taodaSettings" style="display:none;">
        <p class="print-tips" id="taodaTips">如果无法正常打印，请先下载安装<a href="/noteprinttemp.do?action=downloadTemplateReader" target="_blank">友商网套打工具</a></p>
 ...
 (function($){
    ...
    function init(){
      ...
      if (parent.parent.SYSTEM.serviceType == 8) {
        var taodaTips  = '您的帐套为免费版，须购买付费版才能使用套打功能，<a href="" target="_blank">点击购买</a>'
