...
<link href="<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/default.css?ver=20170122" rel="stylesheet" type="text/css" id="defaultFile">
...
var SYSTEM = {
	version: 1,
	skin: "blue",//<?php echo sys_skin()?> //去掉自定义点数
	language:"",
	site:"",
...
function markupVension(){
	var imgSrcList = {
				...
				standard:'<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/img/icon_v_s_e.png', //标准版正式版
	...
	if(SYSTEM.siType === 1){
		switch(SYSTEM.siVersion){
			case 1:	imgModel.attr('src',imgSrcList.baseTrial).attr('alt','基础版试用版');
				break;
			case 2:	imgModel.attr('src',imgSrcList.baseExp).attr('alt','免费版');
				break;
...
<div id="container" class="cf">
  <div id="col-side">
    ...
    <li class="item item-vip"> <a href="javascript:void(0);" class="vip main-nav">高级<span class="arrow">&gt;</span></a>
      ...
      <li class="item item-purchase"> <a href="javascript:void(0);" class="purchase main-nav">进货<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="purchase">
          </ul>
        </div>
      </li>
      <li class="item item-sales"> <a href="javascript:void(0);" class="sales main-nav">发货<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
...
<!--
      	...
      	<li class="space">|</li>
         <li class="qq"><a href="" onClick="return false;" id="wpa">QQ咨询：15577729055</a></li> 
      	<li class="space">|</li>
...
-->
       ...
       <!-- <li><a href="" target="_blank">帮助</a></li>
        <li class="space">|</li>-->
        <li><a href="<?php echo site_url('login/out')?>">退出账号</a></li>
      </ul>  
    </div>
    <div id="main-bd">
...
if(SYSTEM.userName != "admin"){
  // $("#nav>li").addClass("dn");
  // $(".item-report").removeClass("dn").css("margin-top","250px");
}
	//判断权限可见
	$('.nav ul li a,#nav .sub-nav a').addClass("dn");
  var classlist = "";
$.each(SYSTEM.rights, function(index, value, array) {
  console.log(index);
  if(value){
 	 $("a[data-right="+index+"]").removeClass("dn");
  }
});
</script>
</body>
