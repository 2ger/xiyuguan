...
<div id="hd" class="cf">
  <div class="fl welcome cf">
	  ...
	  <a href="javascrip:void(0);" id="manageAcct">修改密码</a>
...
.btn{text-align:center;padding:20px}
.btn a{ 
margin:10px 0px;
  display: block;
    padding: 12px;
...
<div class="col-extra">
    <div class="extra-wrap admin">
      <h2>业务流程图</h2>
      <div class="list btn">

<a  tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="<?=site_url('settings/goods_list')?>" class="btn-item">添加商品</a>

<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="购货单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invPu?action=initPur')?>" class="btn-item"><span></span>采购入库</a>
<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="storage-transfers" data-right="TF_ADD" tabTxt="门店申请" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSo?action=initSoList')?>" class="btn-item"><span></span>门店申请</a>
<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="<?php echo site_url('storage/inventory')?>" class="btn-item"><span></span>库存盘点</a>

      </div>
    </div>

<div class="extra-wrap user">
      <h2>业务流程图</h2>
      <div class="list btn">
<a  tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="订货记录" parentOpen="true" rel="pageTab" href="<?=site_url('scm/invSo?action=initSoList')?>" id="dinghuo" class="btn-item">订货申请</a>
<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="purchase-purchase" data-right="PU_ADD" class="btn-item"><span></span>总部审批</a>
<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="storage-transfers" data-right="TF_ADD" class="btn-item"><span></span>源材料入库</a>
<img src="http://download.easyicon.net/png/1167946/48/" alt="">
        	<a tabid="storage-inventory" id="pandian" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="<?php echo site_url('storage/inventory')?>" class="btn-item"><span></span>库存盘点</a>
      </div>
    </div>



<div class="extra-wrap dn">
      <h2>快速查看</h2>
      <div class="list">
        <ul>
  ...
  <div class="col-main">
    <div class="main-wrap cf">
      <div class="m-top cf dn" id="profileDom">
...
font-size:14px;
    background: #346fb9 url(img/index_h2_bg.png) 0 0 repeat-x;
      ...
      <h2 class="qick-h2 admin">常用功能</h2>
      <ul class="quick-links admin">
        ...
        <li class="sales-sales">
        	<a tabid="storage-transfers" data-right="TF_ADD" tabTxt="门店申请" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSo?action=initSoList')?>"><span></span>门店申请</a>
        </li>
        <li class="sales-sales">
        	<a tabid="sales-sales" data-right="SA_ADD" tabTxt="销货单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSa?action=initSaleList')?>"><span></span>销货单</a>
        </li>
        <!-- <li class="sales-sales">
        ...
        <li class="added-service">
        	<a tabid="setting-addedServiceList" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/goods_list')?>"><span></span>商品管理</a>
        </li>
        <li class="feedback">
        	<!-- <a href="#" id="feedback"><span></span>意见反馈</a> -->
        	<a tabid="setting-addedServiceList" tabTxt="供应商管理" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/vendor_list')?>"><span></span>供应商管理</a>
        </li>
      </ul>
    </div>
  </div>
...
#pandian,#dinghuo{background:green!important;border-color:green!important}
</style>
<script>
  // $(".btn-item").addClass("dn").css("margin-top","250px");
console.log(parent.SYSTEM.userName);
if(parent.SYSTEM.userName != "admin"){
console.log("非管理员");
  $(".admin").addClass("dn");
  // $(".btn>a").attr({"disable":"true","parentOpen":""});
  // $("#pandian").attr({"disable":"false","parentOpen":"true"});
}else{
  $(".user").addClass("dn");
}
</script>
