...
class backlist{
	...
	function getModuleFrames($name){
		...
		$frames['merchant']['title'] = '<i class="fa fa-spinner"></i>&nbsp;&nbsp; 商家';
		$frames['merchant']['items'] = array();
		$frames['merchant']['items']['merchant']['url'] = url('site/entry/merchant/',array('m'=>$name));
		$frames['merchant']['items']['merchant']['title'] = '商家管理';
		$frames['merchant']['items']['merchant']['actions'] = array();
		$frames['merchant']['items']['merchant']['active'] = '';
		
		$frames['merchant']['items']['account']['url'] = url('site/entry/account/',array('m'=>$name));
		$frames['merchant']['items']['account']['title'] = '商家结算中心';
		$frames['merchant']['items']['account']['actions'] = array();
		$frames['merchant']['items']['account']['active'] = '';
