<?php
	...
	$carrier_list = array();
	$dispatch = false;
	$dispatch_list = pdo_fetchall("select id,dispatchname,dispatchtype,firstprice,firstweight,secondprice,secondweight,areas,carriers from " . tablename("tg_dispatch") . " WHERE  uniacid = {$_W['uniacid']} and id='{$goods['yunfei_id']}' order by displayorder desc");
	...
	if (checksubmit('submit')) {
		...
		$data = array(
			...
			'pay_price' => $price*$num+$freight-$firstdiscount,
