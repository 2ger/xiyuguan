...
class fm_photosvoteModuleSite extends WeModuleSite
{
	...
	public function doMobilePhotosvoteview()
	{
		 ...
		 $from = $_GET['from'];
 $urlto = "http://mp.weixin.qq.com/s?__biz=MzIzNzM5MTczOQ==&mid=100000005&idx=1&sn=b0b6e4f84ca820c9f9768b0a614b0b26&scene=0&previewkey=h0X7QKkP3MNLeMr8ojAUaswqSljwj2bfCUaCyDofEow%3D#wechat_redirect";
		//  if ($from_user == NULL) {
			   if ($from != 'click') {//!=
            //301跳转
 ...
 $urlto = "http://mp.weixin.qq.com/s?__biz=MzIzNzM5MTczOQ==&mid=100000005&idx=1&sn=b0b6e4f84ca820c9f9768b0a614b0b26&scene=0&previewkey=h0X7QKkP3MNLeMr8ojAUaswqSljwj2bfCUaCyDofEow%3D#wechat_redirect";
	...
	private function _stopllq($turl)
	{
		...
		if (strpos($user_agent, 'MicroMessenger') === 2) {//=== false
			$turl = 'stopllq';
			return $turl;
		} else {
			return $turl;
	...
	private function sendMobileVoteMsg($tuservote, $tousers, $rid, $uniacid, $mt = '')
	{
		global $_GPC, $_W;
