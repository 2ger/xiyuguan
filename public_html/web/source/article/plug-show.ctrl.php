<?php
/**
 * [wx866 System] Copyright (c) 2015 wx866.com
 * wx866 is NOT a free software, it under the license terms, visited http://www.wx866.com/ for more details.
 */
...
load()->func('file');
	...
	if (!empty($modules)) {
		foreach ($modules as $mid => $module) {
			...
			$modules[$mid]['official'] = empty($module['issystem']) && (strexists($module['author'], 'wx866 Team') || strexists($module['author'], '微擎团队'));
