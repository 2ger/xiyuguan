				...
				<li id="<?php  echo $li['id'];?>">
					<div>
						...
						<div>
							...
							<input autocomplete="off" class="number inputnum" type="hidden" name="prices[<?php  echo $li['id'];?>]" value="<?php  echo $prices[$li['id']];?>"> 

							<span class="count"><?php  echo $dishes[$li['id']];?></span>
							<span>库存<?php  echo $li['qty'];?><?php  echo $li['unitName'];?> 
<?php  if($prices[$li['id']]>0) { ?>/ 价格：<?php  echo $prices[$li['id']];?> 元 <?php  } ?>
								</span>
						</div>
					</div>
				</li>
