		...
		<ul class="store_list" id="store_list">
			<?php  if(!empty($data)) { ?>
				<?php  if(is_array($data)) { foreach($data as $da) { ?>
					<li onclick="window.location.href='<?php  echo $this->createMobileUrl('dish', array('sid' => $da['id']))?>'" class="url" data-locax="<?php  echo $da['location_x'];?>" data-locay="<?php  echo $da['location_y'];?>">
						<div class="img_tt">
							<div>
						...
						<div class="main_info">	
							...
							<div>
								<a href="tel:<?php  echo $da['telephone'];?>">电话:<?php  echo $da['telephone'];?></a>
