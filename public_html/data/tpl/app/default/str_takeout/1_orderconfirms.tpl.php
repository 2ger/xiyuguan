	...
	<section class="pay_wrap">
		...
		<ul class="box pay_box" id="is_meal" <?php  if($return || ($store['is_meal'] == 2)) { ?>style="display:none"<?php  } ?>>
			...
			<li>
					<strong>名称：</strong>
					<span>
						<input class="txt" name="realname" placeholder="店名" id="realname" value="<?php  echo $storeTitle;?>">
					</span>
			</li>
            <!-- <li> -->
                    <!-- <strong>手机号码：</strong> -->
			...
			<li>
					<strong>联系人：</strong>
					<span>
						<input class="txt" type="text" name="linkname" placeholder="联系人" id="linkname" value="<?php  echo $realname;?>">
					</span>
			</li>
