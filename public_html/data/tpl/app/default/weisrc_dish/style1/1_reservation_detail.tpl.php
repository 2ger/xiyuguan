        ...
        <div id="new-reservation-order-form" class="main-view">
            ...
            <div class="section">
                ...
                <div class="list-item">
                    ...
                    <span class="reservation-time ng-binding"><?php  echo $select_date;?> <?php  echo $time['time'];?></span>
                </div>
                <div class="list-item">
...
<input type="hidden" id="select_date" name="select_date" value="<?php  echo $select_date;?> <?php  echo $time['time'];?>">
        ...
        if (true) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    alert("订单提交成功！");
                    var url = "<?php  echo $this->createMobileUrl('reservationIndex', array('storeid'=>$storeid,'mode'=>3), true)?>";
                    location.href = url;
