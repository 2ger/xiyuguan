...
<div id="setting" class="mui-page">
    ...
    <div class="mui-navbar-inner mui-bar mui-bar-nav">
        ...
        <h1 class="mui-center mui-title">原材料库存</h1>
    ...
    .bgred{
        ...
        color: #fff;
                ...
                <ul class="mui-table-view">
                    <?php  if(is_array($materlist)) { foreach($materlist as $item) { ?>
                    <li class="mui-table-view-cell"><?php  echo $item['name'];?>
                    <a class="mui-btn <?php  if($item['total']<10) { ?>mui-btn-negative<?php  } ?>"><?php  if($item['total']<0) { ?>0<?php  } else { ?><?php  echo $item['total'];?><?php  } ?>/<?php  echo $item['costName'];?></a>
                    </li>
                    <?php  } } ?>
                </ul>
            </div>
