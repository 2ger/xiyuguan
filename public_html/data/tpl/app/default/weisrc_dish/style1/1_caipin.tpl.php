...
<div id="setting" class="mui-page">
    ...
    <div class="mui-navbar-inner mui-bar mui-bar-nav">
        ...
        <h1 class="mui-center mui-title">菜品管理</h1>
...
.bgred{
    ...
    color: #fff;
                ...
                <ul class="mui-table-view">
                    ...
                    <li class="<?php  if($item['status']==0) { ?>bgred<?php  } ?> mui-table-view-cell">
                    <?php  echo $item['title'];?>
                    <?php  if($item['status']) { ?>
                    <a class="mui-btn mui-btn-primary" href="<?php  echo $this->createMobileUrl('guqing', array(), true)?>&goodsid=<?php  echo $item['id'];?>&status=0">
                        沽清</a>
                    <?php  } else { ?> 
                    <a class="mui-btn mui-btn-positive" href="<?php  echo $this->createMobileUrl('guqing', array(), true)?>&goodsid=<?php  echo $item['id'];?>&status=1">
                        上架</a>
                    <?php  } ?> 
