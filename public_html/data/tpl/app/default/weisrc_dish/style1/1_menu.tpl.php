        ...
        <article>
            ...
            <ul class="myorder" id="myorder">
                ...
                <li style="height:auto!important">
                    <span class="dishName"><?php  echo $item['title'];?><?php  if($item['flavor']!="") { ?>(<?php  echo $item['flavor'];?>)<?php  } ?></span>
                    <?php  if($item['isspecial']==1) { ?>
                    <i><?php  echo $item['productprice'];?>元/<?php  echo $item['unitname'];?></i>
                    <?php  } else { ?>
                    <i><?php  echo $item['marketprice'];?>元/<?php  echo $item['unitname'];?><!-- <span class="yuanjia"><?php  echo $item['productprice'];?>元/<?php  echo $item['unitname'];?></span> --></i><!-- 注释原价 -->
                    <?php  } ?>

                   <section class="bbox" dishid="<?php  echo $item['id'];?>" dishname="<?php  echo $item['title'];?>">

<style>
.hidden{display:none}
</style>

                        <input class="btn-reduce  <?php  if($item['id']==6) { ?>hidden <?php  } ?>" type="button" value="-">

                        <input class="numBox" name="numBox" type="text" value="<?php  echo $item['total'];?>" price="<?php  if($item['isspecial']==1) { ?><?php  echo $item['productprice'];?><?php  } else { ?><?php  echo $item['marketprice'];?><?php  } ?>" disabled="disabled">

                        <input type="button" class="btn-plus <?php  if($item['id']==6) { ?>hidden <?php  } ?>" value="+">
                    ...
                    <table style="">
                        <tr>
                            ...
                            <td>
                                <select id="goodsid<?php  echo $item['goodsid'];?>" name="taste" style="width:100%!important;padding:2px!important">
                                    <?php  if(is_array($item['tasteid'])) { foreach($item['tasteid'] as $row2) { ?>
    ...
    <section style="margin-bottom: 20px;">
        <article>
            <?php  if($mode == 1) { ?>
            <h2 style="color:#f00;">桌号：<?php  echo $table_title;?></h2>
            <?php  } ?>
            <div id="form_dish" target="hide" <?php  if($mode == 1) { ?>style="border-top: 1px #e7eaeb solid;margin-top: 10px;"<?php  } ?>>
                <table class="table_book">
                   ...
                   <!--  <tr>
                        <td width="80px" style="width: 80px;">手机号码：</td>
                        <td colspan="2"> -->
                            <!-- <input type="hidden" id="tel" name="tel" value="<?php  if(!empty($user['mobile'])) { ?><?php  echo $user['mobile'];?><?php  } ?>" maxlength="13" style="width: 200px;" placeholder="请输入手机号码"> -->
                            <input type="hidden" id="tel" name="tel" value="15577729055" maxlength="13" style="width: 200px;" ></td>
                    <!-- </td></tr> -->
                    <!-- <tr>
                        <td style="width: 80px;">用户姓名：</td>
                        <td style="width: 50%;"> -->
                            <input type="hidden" name="guest_name" id="name" value="莫深辰" maxlength="10" style="width: 100px;" >
                            <!-- <input type="hidden" name="guest_name" id="name" value="<?php  echo $table_title;?>" maxlength="10" style="width: 100px;" placeholder="请输入您的姓名"> -->
                        <!-- </td>
                        <td>
                    ...
                    <tr style="display:none">
                        ...
                        <td colspan="2">
                            <input type="text" id="counts" name="counts" value="4" maxlength="3" style="width: 100px;" placeholder="请填写用餐人数">
                        </td>
                    </tr>
                    <!-- <tr>
...
function postmain() {
    ...
    if (true) {
        ...
        var url = "<?php  echo $this->createMobileUrl('addtoorder', array('storeid' => $storeid, 'from_user' => $from_user, 'tables' =>$tables), true)?>";

        var address = $("#address").val();
        var totalprice = parseFloat(_q("#totalprice").value);


                //alert($("#goodsid6 option:selected").text());
                <?php  if(is_array($cart)) { foreach($cart as $item) { ?>
                //alert(<?php  echo $item['goodsid'];?>+$("#goodsid$item['goodsid']} option:selected").text());
                //"<?php  echo $item['goodsid'];?>":$("#<?php  echo $item['goodsid'];?> option:selected").text(),
                <?php  } } ?>
        //return false;
        $.ajax({
            ...
            data: {
                ...
                <?php  if(is_array($cart)) { foreach($cart as $item) { ?>
                "goodsid<?php  echo $item['goodsid'];?>":$("#goodsid<?php  echo $item['goodsid'];?> option:selected").val(),
                <?php  } } ?>
                "meal_time": mealtime,
                //"goodsid6":$("#goodsid6 option:selected").val(),
                "counts": $("#counts").val(),
            ...
            success: function (data) {
                if (data.message['code'] != 0) {
                    var url = "<?php  echo $this->createMobileUrl('orderdetail', array('id' => $order['id'], 'agid' =>'1'), true)?>"+"&orderid="+data.message['orderid'];
                    location.href = url;
                } else {
