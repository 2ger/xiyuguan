...
function doSelected() {
    document.getElementById('order').href = "<?php  echo $this->createMobileUrl('wapselectlist', array('storeid' => $storeid, 'from_user' => $from_user, 'tablesid' => $tablesid, 'mode' => $mode), true)?>"+'&num='+_selectedCount;
}
</script>
</body>
</html>