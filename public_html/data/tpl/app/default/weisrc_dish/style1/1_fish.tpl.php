...
<!--<link data-turbolinks-track="true" href="../addons/weisrc_dish/template//mobile/style1/assets/diandanbao/weixin.css" media="all" rel="stylesheet">-->
...
<div ng-view="" style="height: 100%;" class="ng-scope">
    <div class="ddb-nav-header ng-scope" common-header="">
        ...
        <div class="header-title ng-binding">鱼</div>
 ...
 <?php  include $this->template($this->cur_tpl.'/_menu3');?>
        ...
        <div class="order-item section <?php  echo $items['status'];?> ng-scope">
            ...
            <?php  if($_SESSION['pcate']==3) { ?>
            <a class="list-item" onclick="go_detail(<?php  echo $items['id'];?>,<?php  echo $items['storeid'];?>,<?php  echo $items['tablesid'];?>,<?php  echo $items['stepnow'];?>)">
            <?php  } else { ?>
            <a class="list-item">
            <?php  } ?>
                ...
                <div class="name ng-binding"><?php  echo $items['title'];?><?php  if($items['flavor']!="") { ?>(<?php  echo $items['flavor'];?>)<?php  } ?> * <?php  echo $items['total'];?> <?php  echo $items['unitname'];?></div>
            ...
            <div class="list-item" style="margin-top: 15px;">
                ...
                <div class="operation" >
                    <span class="button ng-binding ng-scope" style="color:#ff0000;" onclick="go_reminder(<?php  echo $items['id'];?>,<?php  echo $items['storeid'];?>,<?php  echo $items['tablesid'];?>)">催  菜</span>
                    <span class="button  ng-binding ng-scope" style="color:#28a267;"><?php  if($items['stepnow']==0) { ?>称鱼<?php  } else if($items['stepnow']==1) { ?>杀鱼<?php  } else if($items['stepnow']==2) { ?>腌鱼<?php  } else if($items['stepnow']==3) { ?>煮鱼<?php  } else if($items['stepnow']==4) { ?>配送<?php  } else if($items['stepnow']==5) { ?>上桌<?php  } ?></span>
                </div>
                <div class="space"></div>
            </div>
        </div>
