    ...
    <div class="orders-index-page main-view ng-scope" id="delivery-orders-index">
        ...
        <div class="order-item section ng-scope" onclick="go_detail(<?php  echo $items['id'];?>)">
            ...
            <div class="list-item">
                ...
                <div class="operation">
                    <span class="button ng-binding ng-scope" style="color:<?php  if($items['status']==-1) { ?>#28a267<?php  } else { ?>#ef4437;<?php  } ?>"><?php  if($items['status']==0) { ?>待确认<?php  } else if($items['status']==1) { ?>已确认<?php  } else if($items['status']==2) { ?>已完成<?php  } else if($items['status']==-1) { ?>已取消<?php  } ?></span>
                </div>
                <div class="space"></div>
