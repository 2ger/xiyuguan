...
<div class="product-notice-section ng-binding">
   ...
   <!-- <span style="color:#f00;float:right">选鱼请到前台</span> -->
    <?php  if($limitprice>0) { ?>最低消费<?php  echo $limitprice;?>元<?php  } ?>
</div>
<?php  } ?>
<div class="center" <?php  if($mode != 1) { ?><?php  if(empty($store['announce'])) { ?>style="margin-top: 45px;"<?php  } ?><?php  } ?>>
    <nav id="navBar">
        <dl>
            ...
            <a href="<?php  echo $this->createMobileUrl('waplist', array('storeid' => $storeid, 'from_user' => $from_user,'categoryid' => $item['id'],'mode' => $mode,'tablesid' => $tablesid), true)?>" style="color: #000">
                <dd categoryid="<?php  echo $item['id'];?>" <?php  if($cid==$item['id']) { ?>class="active"<?php  } ?>">
                    <?php  echo $item['name'];?>
            ...
            <?php  } } ?>
            <!-- 套餐17.3.3 -->
            <a href="<?php  echo $this->createMobileUrl('wapselect', array('storeid' => $storeid, 'from_user' => $from_user,'mode' => $mode,'tablesid' => $tablesid), true)?>" style="color: #000">
                <dd>
                    <button style="background-color: #fff; height: 30px;">套 餐</button>
                </dd>
            </a>
            <!-- end -->
        </dl>
        ...
        <article style="border: 0px">
            <div id="pInfo">
                ...
                <dl dunitname="<?php  echo $row['unitname'];?>" dsubcount="<?php  echo $row['subcount'];?>" dishid="<?php  echo $row['id'];?>" dname="<?php  echo $row['title'];?>" dtaste="<?php  echo $row['taste'];?>" ddescribe="<?php  echo $row['description'];?>" dprice="<?php  echo $row['productprice'];?>" dishot="<?php  if($row['subcount']>20) { ?>2<?php  } else { ?>0<?php  } ?>" dspecialprice="<?php  if($row['isspecial']==2) { ?><?php  echo $row['marketprice'];?><?php  } ?>" disspecial="<?php  echo $row['isspecial'];?>" shopinfo="" <?php  if(empty($row['thumb'])) { ?>style="padding-left:0px;"<?php  } ?>>
                    ...
                    <dd>
                        <em class="sale"><?php  echo $row['marketprice'];?>元/<?php  echo $row['unitname'];?>
                            <?php  if(!empty($row['productprice'])) { ?>
                            <!-- <br><del><?php  echo $row['productprice'];?>元/<?php  echo $row['unitname'];?></del> --><!--注释原价-->
                            <?php  } ?>
                        </em>
                    </dd>
...
<script type="text/javascript">
    ...
    function doSelect(){
        ...
        //                 if (dish['dPrice'] != '') {
        //                     var priceHtml = "<em class='sale'>"+dish['dSpecialPrice']+"元/"+dish['unitname']+"<br/></em>";
        //                     //<del>"+dish['dPrice']+"元/"+dish['unitname']+"</del>
        //                 } else {
