...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom:0;">
	...
	<?php  if($pay['delivery']['switch']) { ?><li data-id="delivery" class="delivery"><a href="#collect" role="tab" data-toggle="tab">确认订单</a></li><?php  } ?>
...
<!-- 
	...
	<!-- 		<div class="pay-btn" id="queren-panel">
                
				<form action="<?php  echo url('mc/cash/queren');?>" method="post">
					...
					<button class="btn btn-primary btn-block col-sm-12" type="submit" value="queren">确认订单 </button>
		...
		<div class="tab-pane animated" id="collect">
			...
			<div class="pay-btn" id="delivery-panel">
				...
				<form action="<?php  echo url('mc/cash/delivery');?>" method="post">
					...
					<button class="btn btn-warning btn-block col-sm-12" type="submit" value="delivery">确认订单</button>
