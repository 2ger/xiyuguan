  ...
  <div class="jrow">
    <div class="jcell body_left">
      ...
      <div class="body_left_menu">
        <ul>
          <li class="jlabel"><strong>功能</strong></li>
          <li onClick="extendFun(1);">未打印</li>
          <li onClick="extendFun(2);">记录</li>
          <?php  if(count($btnlist)) { ?>
          <li class="jlabel"><strong>扩展</strong></li>
      ...
      <div class="body_right_menu row">
        <div class="col-sm-4">
          <div class="body_right_meneybox">
            <h2 class="bg_yellow"><img src="<?php echo MODULE_URL;?>template/img/wechart.gif" height="50"/></h2>
        ...
        <div class="col-sm-4">
          <div class="body_right_meneybox">
            <h2 class="bg_green"><img src="<?php echo MODULE_URL;?>template/img/alipay.gif" height="50"/></h2>
            <div class="body_right_moneybox_btm row">
        ...
        <div class="col-sm-4">
          <div class="body_right_meneybox">
            <h2 class="bg_blue"><img src="<?php echo MODULE_URL;?>template/img/card.png" height="50"/></h2>
            <div class="body_right_moneybox_btm row">
...
$(document).ready(function(e) {
	if($(document).width()>1100){
		...
		location.href='<?php  echo $this->createMobileUrl(index,array("small"=>0,"op"=>"login"))?>';
	}
...
function getCounterRecord(){
	$.post("<?php  echo $this->createMobileUrl('ajax',array('op'=>'getcounterrecord'))?>",{},function(data){
		...
		$("#j_getrecord").empty();
		for(i in record){
			var temp='<tr><td scope="row">'+record[i]['createtime']+'</td><td>'+(record[i]['paytype']=="微信" ? '<img src="<?php echo MODULE_URL;?>template/img/wechart.gif" height="21"/> ':'<img src="<?php echo MODULE_URL;?>template/img/alipay.gif" height="21"/> ')+(record[i]['attach']=='-' || record[i]['attach']=='PC' ? '<span class="label label-info"><i class="fa fa-desktop"/></i></span>':'<span class="label label-danger"><i class="fa fa-mobile"/></i></span>')+'</td><td>'+record[i]['total_fee']+'</td><td>'+record[i]['coupon_fee']+'</td><td>'+record[i]['cash_fee']+'</td><td>';
			...
			$.post("<?php  echo $this->createMobileUrl('ajax',array('op'=>'getcounternoprintrecord'))?>",{},function(data){
				...
				for(i in record){
					...
					if(record[i]['paytype']=='微信'){
						temp+='<img src="<?php echo MODULE_URL;?>template/img/wechart.gif" width="21"/>';
					}else{
						temp+='<img src="<?php echo MODULE_URL;?>template/img/alipay.gif" width="21"/>';
					}
					temp+='</td>';
