        ...
        <div class="panel-body">
            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th style="width:10%;">桌台类型</th>
                        <!-- <th style="width:18%;">预定时间</th> -->
                        <th style="width:18%;">用餐时间</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php  if($item['status']==0) { ?><a class="btn btn-info btn-sm">待处理</a><?php  } else if($item['status']==1) { ?><a class="btn btn-success btn-sm">已确认</a><?php  } else if($item['status']==-1) { ?><a class="btn btn-danger btn-sm">已取消</a><?php  } ?>
                        </td>
                        <td style="max-width:70px;text-align: center;">
                            <a class="btn btn-default btn-sm" href="index.php?i=1&c=entry&op=post&id=<?php  echo $item['id'];?>&storeid=<?php  echo $storeid;?>&do=reservation&m=j_money" title="确认">确认</a>
                            <a class="btn btn-danger btn-sm" href="index.php?i=1&c=entry&op=delete&id=<?php  echo $item['id'];?>&storeid=<?php  echo $storeid;?>&do=reservation&m=j_money" onclick="return confirm('确认操作吗？');return false;" title="取消">取消</a>
                        </td>
                    </tr>
                    <?php  } } ?>
                    </tbody>
