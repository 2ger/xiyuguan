    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <a class="btn btn-primary btn-sm" href="index.php?i=1&c=entry&op=post&do=queuesetting2&m=j_money">新建 队列设置</a>
            </div>
        <div id="queue-setting-index-body">
            ...
            <a class="<?php  echo $curcolor;?> queue_setting" href="index.php?i=1&c=entry&op=post&do=queuesetting2&storeid=$storeid&id=<?php  echo $item['id'];?>&m=j_money">
