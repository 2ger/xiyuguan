...
<?php  } ?>
                                ...
                                <a class="btn btn-danger tui" total="<?php  echo $item['total'];?>" orderid="<?php  echo $item['orderid'];?>" tablesid="<?php  echo $tablesid;?>" goodsid="<?php  echo $item['goodsid'];?>" price="<?php  echo round($item['ttprice'],2);?>" id="<?php  echo $item['id'];?>">退</a>
                                <?php  } ?>
