...
<?php  if($show_footer && $show_copyright) { ?>
   <?php  if(!empty($systemcopyright)) { ?>
     <div style='display:none;margin:0;padding:0;padding-bottom:50px;float:left;width:100%;background-color:<?php  echo $systemcopyright['bgcolor'];?>' id="systemcopyright">
