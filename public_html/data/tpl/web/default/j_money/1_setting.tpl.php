...
<div class="main">
  <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1">
    <div class="panel panel-default">
      ...
      <div class="panel-body" <?php  if(!$_W['isfounder']) { ?>style="display:none"<?php  } ?>>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <button type="button" class="btn btn-default" onClick="$('#rootca').click()"><?php  if($settings['rootca']) { ?>已上传-点击修改<?php  } else { ?>请上传rootca.pem<?php  } ?></button>
          <input type="hidden" name="rootca2" value="<?php  echo $settings['rootca'];?>"/> rootca.pem
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          ...
          <input type="hidden" name="apiclient_cert2" value="<?php  echo $settings['apiclient_cert'];?>"/>apiclient_cert.pem
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          ...
          <input type="hidden" name="apiclient_key2" value="<?php  echo $settings['apiclient_key'];?>"/>apiclient_key.pem
      ...
      <div class="panel-body" <?php  if(!$_W['isfounder']) { ?>style="display:none"<?php  } ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <button type="button" class="btn btn-default" onClick="$('#alipay_public_key_file').click()"><?php  if($settings['alipay_public_key_file']) { ?>已上传-点击修改<?php  } else { ?>请上传alipay_public_key_file.pem<?php  } ?></button>
            <input type="hidden" name="alipay_public_key_file2" value="<?php  echo $settings['alipay_public_key_file'];?>"/>alipay_public_key_file.pem
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <button type="button" class="btn btn-default" onClick="$('#merchant_private_key_file').click()"><?php  if($settings['merchant_private_key_file']) { ?>已上传-点击修改<?php  } else { ?>请上传merchant_private_key_file.pem<?php  } ?></button>
            <input type="hidden" name="merchant_private_key_file2" value="<?php  echo $settings['merchant_private_key_file'];?>"/>merchant_private_key_file.pem
            <input type="file" name="merchant_private_key_file" value="<?php  echo $settings['merchant_private_key_file'];?>" id="merchant_private_key_file" style="display:none;">
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-2 control-label">服务器公匙</label>
          <div class="col-sm-9">
            <button type="button" class="btn btn-default" onClick="$('#merchant_public_key_file').click()"><?php  if($settings['merchant_public_key_file']) { ?>已上传-点击修改<?php  } else { ?>请上传merchant_public_key_file.pem<?php  } ?></button>
            <input type="hidden" name="merchant_public_key_file2" value="<?php  echo $settings['merchant_public_key_file'];?>"/>merchant_public_key_file.pem
      ...
      <div class="panel-body">
          ...
          <div class="col-sm-9">
            <label class="radio-inline">
              <input type="radio" name="needtable" value="0" <?php  if($settings['needtable'] == 0) { ?> checked<?php  } ?> />
              关闭</label>
            <label class="radio-inline">
              <input type="radio" name="needtable" value="1" <?php  if($settings['needtable'] == 1) { ?> checked<?php  } ?> />
              开启</label>
