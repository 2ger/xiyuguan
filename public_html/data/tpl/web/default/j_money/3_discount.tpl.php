...
<ul class="nav nav-tabs">
  <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('discount', array('op' => 'post'))?>">添加折扣活动</a></li>
  <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('discount', array('op' => 'display'))?>">管理折扣活动</a></li>
</ul>
<script>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body"> 
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 form-inline"><input type="text" name="discount" value="<?php  echo $reply['discount'];?>">
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td><span class="label label-default"><?php  echo $row['discount'];?></span></td>
