				...
				<form action="./index.php" method="get" role="form" class="form-horizontal">
					...
					<div class="form-group" style="margin-left: 40px">
						...
						<div class="col-sm-8 col-lg-10 col-xs-12">
							<div class="btn-group">
								<a href="<?php  echo url('account/display');?>"  class="btn <?php  if($_GPC['type'] == '') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" style="width: 80px">全部</a>
								<a href="<?php  echo url('account/display', array('type' => '1'));?>"  class="btn <?php  if($_GPC['type'] == '1') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">普通接入</a>
								<a href="<?php  echo url('account/display', array('type' => '3'));?>"  class="btn <?php  if($_GPC['type']== '3') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">登录授权</a>
							</div>
						</div>
					</div>
