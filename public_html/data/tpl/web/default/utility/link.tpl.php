	...
	<table class="table table-hover">
		...
		<?php  if(is_array($result['list'])) { foreach($result['list'] as $list) { ?>
			<tr>
				...
				<td><button class="btn btn-default select" onclick="clicklink('./index.php?i=<?php  echo $list['uniacid'];?>&c=home&pageid=<?php  echo $list['id'];?>', '<?php  echo $list['title'];?>')">选取</button></td>
			</tr>
		<?php  } } ?>
		</tbody>
	</table>
...
<div class="tab-pane active" role="tabpanel">
	<table class="table table-hover">
		...
		<tr>
			<td><a href="#"><?php  echo $list['title'];?></a></td>
			<td><a href="#"></a></td>
			<td><button class="btn btn-default select" onclick="clicklink('./index.php?i=<?php  echo $list['uniaicd'];?>&c=entry&id=<?php  echo $list['id'];?>&do=detail&m=news')">选取</button></td>
		</tr>
		<?php  } } ?>
		</tbody>
	</table>
		...
		<table class="table table-hover">
			...
			<?php  if(is_array($category)) { foreach($category as $cate) { ?>
				<tr>
					...
					<td class="text-right"><button class="btn btn-default select" onclick="clicklink('./index.php?c=site&a=site&cid=<?php  echo $cate['id'];?>&i=<?php  echo $cate['uniaicd'];?>')">选取</button></td>
				</tr>
				...
				<tr>
					...
					<td class="text-right">
						<button class="btn btn-default select" onclick="clicklink('./index.php?c=site&a=site&cid=<?php  echo $child['id'];?>&i=<?php  echo $child['uniaicd'];?>')">选取</button>
					</td>
				</tr>
				<?php  } } ?>
			<?php  } } ?>
