		...
		<form action="" class="form-horizontal form" method="post" enctype="multipart/form-data" >
			...
			<div class="panel-body">
			 	...
			 	<div class="form-group">
			 		...
			 		<div class="col-sm-8">
				 		<label class="radio-inline"><input type="radio" name="isshow" value="1" <?php  if($item['isshow'] == '1') { ?> checked="checked"<?php  } ?>/> 是</label>
				 		<label class="radio-inline"><input type="radio" name="isshow" value="0" <?php  if($item['isshow'] != '1') { ?> checked="checked"<?php  } ?>/> 否</label>
			 		</div>
			 	</div>
			 	<div class="form-group">
					<label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label">技师介绍</label>
					<div class="col-sm-8 col-xs-12">
						<textarea class="form-control richtext" name="project_info" rows="10"><?php  echo $item['project_info'];?></textarea>
					</div>
				</div>
	 		</div>
			</div>
