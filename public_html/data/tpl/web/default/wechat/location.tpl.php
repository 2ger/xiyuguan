...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'logo') { ?>class="active"<?php  } ?>><a href="<?php  echo url('wechat/location/logo');?>">门店logo</a></li>
	<li <?php  if($do == 'list' ||  $do == 'edit') { ?>class="active"<?php  } ?>><a href="<?php  echo url('wechat/location/list');?>">门店列表</a></li>
	<?php  if($do == 'post') { ?><li class="active"><a href="<?php  echo url('wechat/location/post');?>">添加门店</a></li><?php  } ?>
</ul>
<style>
