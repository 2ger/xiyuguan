			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-9 col-md-9">
							<label class="radio-inline"><input type="radio" name="dish_style" value="1" <?php  if($item['dish_style'] == 1) { ?>checked<?php  } ?>> 默认风格</label>
							<label class="radio-inline"><input type="radio" name="dish_style" value="2" <?php  if($item['dish_style'] == 2) { ?>checked<?php  } ?>> 风格1</label>
						</div>	
					</div>
					<div class="form-group">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						<div class="col-sm-9 col-xs-12">
							...
							<?php  } else { ?>
								<?php  if(is_array($accounts)) { foreach($accounts as $acc) { ?>
									<label class="radio-inline">
										<input type="radio" value="<?php  echo $acc['acid'];?>" name="notice_acid" <?php  if($item['notice_acid'] == $acc['acid']) { ?>checked<?php  } ?>> <?php  echo $acc['name'];?>
									</label>
								<?php  } } ?>
							<?php  } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<label class="radio-inline">
								<input type="radio" value="1" name="notice_type" <?php  if($item['notice_type'] == 1) { ?>checked<?php  } ?> onclick="$('#notice_type_tpl').hide()"> 客服消息通知
							</label>
							<label class="radio-inline">
								<input type="radio" value="2" name="notice_type" <?php  if($item['notice_type'] == 2) { ?>checked<?php  } ?> onclick="$('#notice_type_tpl').show()"> 模板消息通知
							</label>
							<div class="help-block text-danger"><b>模板消息通知需要您的公众号为认证服务号，并且有使用相应模板的功能</b></div>
						</div>
					</div>
					<div id="notice_type_tpl" <?php  if($item['notice_type'] == 1) { ?>style="display:none"<?php  } ?>>
						<div class="form-group">
							<label class="col-xs-12 col-sm-3 col-md-2 control-label">商家提醒模板id</label>
							<div class="col-sm-9 col-xs-9 col-md-9">
								<input type="text" class="form-control" name="store_tpl" value="<?php  echo $item['store_tpl'];?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-xs-9 col-md-9">
								<input type="text" class="form-control" name="member_tpl" value="<?php  echo $item['member_tpl'];?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-xs-9 col-md-9">
								<input type="text" class="form-control" name="delivery_tpl" value="<?php  echo $item['delivery_tpl'];?>">
