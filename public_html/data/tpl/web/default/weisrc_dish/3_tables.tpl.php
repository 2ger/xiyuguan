                ...
                <div class="col-xs-12">
                    ...
                    <div class="state-table" data-id="<?php  echo $item['id'];?>">
                        ...
                        <div class="name overflow-ellipsis">
                            <span><a href="<?php  echo $this->createWebUrl('tables', array('op' => 'detail', 'storeid' => $storeid, 'tablesid' => $item['id']))?>"><?php  echo $item['type']['title'];?>--<?php  echo $item['title'];?></a></span>
                            ...
                            <div style="height: 40px;"><?php  if($item['status']>1) { ?><?php  echo $item['totalprice']['totalprice'];?>元
                            <?php  } else if($item['status']>0 && $item['status']< 3) { ?>
