    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('queuesetting2', array('op' => 'post', 'storeid' => $storeid))?>">新建 队列设置</a>
            </div>
        <div id="queue-setting-index-body">
            ...
            <a class="<?php  echo $curcolor;?> queue_setting" href="<?php  echo $this->createWebUrl('queuesetting2', array('op' => 'post', 'storeid' => $storeid, 'id' => $item['id']))?>">
