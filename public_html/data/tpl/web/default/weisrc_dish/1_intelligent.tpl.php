        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="catename" class="form-control" value="<?php  echo $intelligent['name'];?>" placeholder="适合用餐人数" />
                    </div>
                </div>
                <!-- 自定义套餐2016.10.26 -->
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">自定义套餐</label>
                    <div class="col-sm-9">
                        <input type="text" name="catetitle" class="form-control" value="" placeholder="自定义套餐名称" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <!-- 修改传由id改为title -->
                            <input type="checkbox" name="goodsids[]" value="<?php  echo $item['title'];?>" <?php  if(!empty($intelligent['name'])) { ?><?php  if(in_array($item['id'], $goodsids)) { ?>checked<?php  } ?><?php  } ?>> <span class="label"><?php  echo $item['title'];?></span>
                        </label>
                        <?php  } } ?>
                        <br>
                        <?php  } } ?>
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td style="white-space:normal;">
                    ...
                    <label class="checkbox-dish"><span class="label" ><?php  echo $goodsid;?></span></label>
                    <?php  } } ?>
                </td>
