        ...
        <div class="panel-body">
            <div class="row">
                <ul class="nav nav-pills" role="tablist">
                    <li class="active">
                        <a href="<?php  echo $this->createWebUrl('materialzones', array('op' => 'display', 'storeid' => $storeid))?>">物资类型</a>
                    </li>
                    <li>
            ...
            <div class="form-group">
                <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('materialzones', array('op' => 'post', 'storeid' => $storeid))?>">新建类型</a>
            </div>
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:16%;">最低消费</th>
                        <th style="width:15%;">预订预付款</th>
                        <th style="width:16%;">物资数量</th>
                        <th style="width:18%;">所属门店</th>
                    ...
                    <tr>
                        ...
                        <td style="max-width:70px;text-align: center;">
                            <a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('materialzones', array('id' => $item['id'], 'storeid' => $storeid, 'op' => 'post'))?>" title="编辑">编辑</a>
                            <a class="btn btn-danger btn-sm" href="<?php  echo $this->createWebUrl('materialzones', array('id' => $item['id'], 'storeid' => $storeid, 'op' => 'delete'))?>" onclick="return confirm('确认操作吗？');return false;" title="删除">删除</a>
                            <a class="btn btn-success btn-sm" href="<?php  echo $this->createWebUrl('materials', array('tablezonesid' => $item['id'], 'storeid' => $storeid, 'op' => 'post'))?>" title="编辑">新建 物资</a>
                        </td>
                    </tr>
                    <?php  } } ?>
                    </tbody>
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <!--<div class="form-group">-->
                    <!--<label class="col-xs-12 col-sm-3 col-md-2 control-label">预付款比例</label>-->
                    <!--<div class="col-sm-9">-->
                        <!--<input type="number" name="limit_num" class="form-control" value="<?php  echo $item['limit_num'];?>" placeholder=""/>-->
                        <!--<span class="help-block">-->
                            <!--预订且点菜时需要预付的百分比 %，随点菜的总金额自动调整-->
                        <!--</span>-->
                    <!--</div>-->
                <!--</div>-->
                <!--<div class="form-group">-->
                    <!--<label class="col-xs-12 col-sm-3 col-md-2 control-label">可预订物资数量</label>-->
                    <!--<div class="col-sm-9">-->
