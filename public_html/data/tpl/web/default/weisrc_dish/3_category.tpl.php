	...
	<!-- <input type="hidden" name="parentid" value="<?php  echo $parent['id'];?>" />  -->
        <div class="panel panel-default">
            ...
            <!-- 16.12.2 -->
                ...
                <div class="form-group">
                <!-- 原为分类描述 -->
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">限制时间</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="ation" style="height: 30px; width: 130px;">
                        <?php  if(is_array($ation)) { foreach($ation as $rows) { ?>
                            <option value="<?php  echo $rows['id'];?>" <?php  if($category['operation'] == $rows['id']) { ?>selected<?php  } ?>><?php  echo $rows['companyname'];?></option>
                        <?php  } } ?>
                        </select>
                    </div>
                </div>
                ...
                <!-- 可打折选项16.12.2 -->
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">打折选项</label>
                    <div class="col-sm-9">
                        <input name="parentid" type="radio" value="1" <?php  if($category['parentid'] == 1) { ?>checked<?php  } ?> > <span style="padding:0 30px 0 5px;">可打折</span>
                        <input name="parentid" type="radio" value="0" <?php  if($category['parentid'] == 0) { ?>checked<?php  } ?>> <span style="padding:0 30px 0 5px;">不可打折</span>
                    </div>
                </div>
                <!-- 可打折选项16.12.2end -->
...
<div class="main">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form action="./index.php" method="post" class="form-horizontal form" onsubmit="return formcheck(this)"  enctype="multipart/form-data">
                <a class="btn btn-default" href="<?php  echo $this->createWebUrl('category', array('op' => 'post', 'storeid' => $storeid))?>"><i class="fa fa-plus"></i> 添加分类</a>
