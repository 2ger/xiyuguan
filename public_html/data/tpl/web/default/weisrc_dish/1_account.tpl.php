...
<ul class="nav nav-tabs" xmlns="http://www.w3.org/1999/html">
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('account', array('op' => 'post'))?>">添加店长账号</a></li>
    <li <?php  if($operation == 'display' || empty($operation)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('account', array('op' => 'display'))?>">店长管理</a></li>
</ul>
                ...
                <div class="form-group hidden">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="identity" value="0" <?php  if($users['identity']==0 || empty($users)) { ?>checked<?php  } ?>>服务员
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="identity" value="1" <?php  if($users['identity'] == 1) { ?>checked<?php  } ?>>厨师
                        </label>
                    </div>
                </div>
        ...
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style="width:20%;">(ID)用户名称</th>
                    <th style="width:20%;">所属门店</th>
                    <th style="width:20%;">职务</th>
                    <th style="width:20%;">上月操作次数</th>
                </tr>
                </thead>
                <tbody id="level-list">
                <?php  if(is_array($account)) { foreach($account as $steps) { ?>
                <tr>
                    <td><?php  echo $steps['id'];?></td>
                    <td>(<?php  echo $steps['id'];?>)<?php  echo $steps['nickname'];?></td>
                    <td><div class="type-parent"><?php  echo $stores[$row['storeid']]['title'];?></div></td>
                    <td><?php  if($steps['identity']==1) { ?>厨师<?php  } else { ?>服务员<?php  } ?></td>
                    <td><?php  echo $steps['num'];?></td>
                </tr>
                <?php  } } ?>
                </tbody>
            </table>
        ...
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style="width:20%;">所属门店</th>
                    <th style="width:20%;">职务</th>
                    <th style="width:20%;">本月操作次数</th>
                </tr>
                </thead>
                <tbody id="level-list">
                <?php  if(is_array($account)) { foreach($account as $stepsn) { ?>
                <tr>
                    <td><?php  echo $stepsn['id'];?></td>
                    <td>(<?php  echo $stepsn['id'];?>)<?php  echo $stepsn['nickname'];?></td>
                    <td><div class="type-parent"><?php  echo $stores[$row['storeid']]['title'];?></div></td>
                    <td><?php  if($stepsn['identity']==1) { ?>厨师<?php  } else { ?>服务员<?php  } ?></td>
                    <td><?php  echo $stepsn['nums'];?></td>
                </tr>
                <?php  } } ?>
                </tbody>
            </table>
