    ...
    <div class="panel panel-default">
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th style="width:31%;">昨天销售额</th>
                        <th style="width:31%;">本月销售额</th>
                        <th style="width:31%;">累计销售额</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td><?php echo (is_string($yesterday['yest']))?$yesterday['yest']."元":"0.00";?></td>
                        <td><?php echo (is_string($month['month']))?$month['month']."元":"0.00";?></td>     
                        <td><?php echo (is_string($moneyall['moneyall']))?$moneyall['moneyall']."元":"0.00";?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="panel panel-default">
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    <thead class="navbar-inner">
                    <tr>
                        <th style="width:31%;">菜名</th>
                        <th style="width:31%;">最新销量排行</th>
                        <th style="width:31%;">总销量排行</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php  if(is_array($goodsRank)) { foreach($goodsRank as $goods) { ?>
                    <tr>
                        <td><?php  echo $goods['title'];?></td>
                        <td><?php  echo $goods['new']['new'];?></td>     
                        <td><?php  echo $goods['allline']['allline'];?></td>
                    </tr>
                    <?php  } } ?>
                    </tbody>
                </table>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php  if($item['status'] == 5) { ?><span class="label label-success">已确定加菜</span><?php  } ?>
